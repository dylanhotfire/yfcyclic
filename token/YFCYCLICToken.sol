...
contract YFCYCLICToken is Ownable {
  ...
  //Presale amount is 6000 tokens so only up to 6000 can be burned if they do not sell
  ...
  //Transfer tokens from this contract and future derived contracts to specified address
  ...
  //Handles presale burn + staking burn if a vault cycle ever calls for it.
